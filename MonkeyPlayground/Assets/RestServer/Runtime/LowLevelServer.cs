...
using RestServer.Runtime.WebSocket;
using UnityEngine;
...
namespace RestServer.Runtime {
    public class LowLevelServer : WsServer {
        ...
        public AdvancedCustomization AdvancedCustomization;
        ...
        public LowLevelServer(EndpointCollection endpointCollection, WsSessionCollection wsSessions, IPAddress address, int port,
            ...
            Action<Socket> additionalSocketConfigurationSession = null, AdvancedCustomization advancedCustomization = null)
            : base(address, port) {
        ...
        protected override TcpSession CreateSession() {
            return AdvancedCustomization.CreateSession(this, _logger, SpecialHandlers, DebugLog);
        }
        ...
        public void RegisterWsSession(WSEndpointId endpointId, LowLevelSession session) {
            ...
            AdvancedCustomization.OnWsConnect(endpointId, session);
        }
        ...
        public void DeregisterWsSession(WSEndpointId endpointId, LowLevelSession session) {
            ...
            AdvancedCustomization.OnWsDisconnect(endpointId, session);
        }
