...
using RestServer.Runtime.VisualScripting.Entity;
using Unity.VisualScripting;

namespace RestServer.Runtime.VisualScripting.Nodes {
    [UnitTitle("Remove Header (Enum)")]
    [UnitCategory("RestServer")]
    [TypeIcon(typeof(Subtract<>))]
    public class RemoveHeaderEnumNode : Unit {
        [DoNotSerialize]
        [PortLabelHidden]
