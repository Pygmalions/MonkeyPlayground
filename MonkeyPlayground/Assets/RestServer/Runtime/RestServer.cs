...
namespace RestServer.Runtime {
    ...
    public class RestServer : MonoBehaviour, ISerializationCallbackReceiver {
        ...
        public AdvancedCustomization AdvancedCustomization {
            get => _advancedCustomization;
            set {
                _advancedCustomization = value;
                if (Server != null) {
                    Server.AdvancedCustomization = _advancedCustomization;
                }
            }
        }
        
        private AdvancedCustomization _advancedCustomization = new AdvancedCustomization();
        ...
        public virtual void StartServer() {
            ...
            Server = _advancedCustomization.CreateLowLevelServer(
