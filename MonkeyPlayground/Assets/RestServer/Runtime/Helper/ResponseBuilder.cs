...
namespace RestServer.Runtime.Helper {
    ...
    public class ResponseBuilder
    {
        ...
        static ResponseBuilder()
        {
            ...
            JsonSerializerOptions.Converters.Add(new TwoDecimalFloatConverter());
        }
        ...
        private bool InternalRedirectScheduled => _request.RedirectHelper?.InternalRedirectPath != null;
        ...
        public ResponseBuilder BodyJson(object obj, string contentType = null) {
            ...
            _body = new ResponseBuilderBodyHelper(JsonSerializer.Serialize(obj, JsonSerializerOptions));
            return this;
        }
        ...
        public bool SendAsync() {
            if (InternalRedirectScheduled) {
                throw new SystemException("Internal redirect scheduled with this response builder, can't send response at the same time.");
            }

            ThreadingHelper.Instance.ThrowIfNotAllowedToSendResponse();
