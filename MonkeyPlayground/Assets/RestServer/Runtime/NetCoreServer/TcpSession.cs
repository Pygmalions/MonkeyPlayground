...
namespace RestServer.Runtime.NetCoreServer {
    /// <summary>
    ...
    public class TcpSession : IDisposable
    {
        ...
        public TcpSession(TcpServer server)
        {
            ...
            // Markus Mod
            AdditionalSocketConfigurationSession = server.AdditionalSocketConfigurationSession;
            // /Markus Mod
        }
        ...
        // Markus Mod
        public Action<Socket> AdditionalSocketConfigurationSession = null;
        // /Markus Mod        
        ...
        internal void Connect(Socket socket)
        {
            ...
            // Markus Mod
            if (AdditionalSocketConfigurationSession != null)
                AdditionalSocketConfigurationSession(Socket);
            // /Markus Mod
