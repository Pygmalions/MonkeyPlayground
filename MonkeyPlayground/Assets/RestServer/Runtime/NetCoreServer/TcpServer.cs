...
namespace RestServer.Runtime.NetCoreServer {
    ...
    public class TcpServer : IDisposable
    {
        ...
        /// </summary>
        public Action<Socket> AdditionalSocketConfigurationServer = null;
        ...
        public virtual bool Start()
        {
            ...
            // Markus Mod
            if (AdditionalSocketConfigurationServer != null)
                AdditionalSocketConfigurationServer(_acceptorSocket);
            // /Markus Mod
