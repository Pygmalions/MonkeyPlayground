...
namespace RestServer.Editor.Inspector {
    [CustomEditor(typeof(Runtime.RestServer))]
    public class RestServerInspector : UnityEditor.Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            var rs = (Runtime.RestServer)target;
        ...
        private string GetRestServerPort(Runtime.RestServer rs) {
        ...
        private void SetSelectedInterface(Runtime.RestServer rs, int oldInterfaceIdx, int newInterfaceIdx) {
            _spListenAddress.enumValueIndex = newInterfaceIdx;
        }

        private int GetSelectedInterface(Runtime.RestServer rs) {
